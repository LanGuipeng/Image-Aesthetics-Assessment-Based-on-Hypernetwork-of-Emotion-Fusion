...
class ResNetBackbone(nn.Module):
    ...
    def __init__(self, lda_out_channels, in_chn, block, layers, num_classes=1000):
        ...
        self.pool_ =  nn.AdaptiveAvgPool2d(output_size=(1, 1))
        self.fc_ = nn.Linear(2048, 224)
        ...
        self.conv=nn.Sequential(
            nn.Conv2d(4096,2048, kernel_size=(1, 1), stride=(1, 1), bias=False),
    ...
    def forward(self, x):
        ...
        # vec = torch.cat((lda_1, lda_2, lda_3, lda_4), 1)       #vec: torch.Size([32, 224])
        vec = self.pool_(x)
